"""update_theory_table_structure

Revision ID: update_theory_table_structure
Revises: add_text_question_to_theory
...
revision = 'update_theory_table_structure'
down_revision = 'add_text_question_to_theory'
branch_labels = None
depends_on = None
